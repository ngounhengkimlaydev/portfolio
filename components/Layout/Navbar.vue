  ...
  <header class="max-w-[1480px] px-4 mx-auto fixed inset-x-0 top-0 mt-4 lg:mt-10 z-50">
    <div class="flex items-center justify-between">
      ...
      <div
        ...
        <NuxtLink class="text-white group text-xl lg:text-base" v-for="link in NAVLINKS" :to="link.url">
        ...
        <!-- Connect Me -->
        <NuxtLink class="lg:hidden text-white group text-xl lg:text-base" href="https://t.me/ngoun_hengkimlay"
      ...
      <div>
        <Button class="rounded-full hidden lg:block shadow-none" label="Connect Me" to="https://t.me/ngoun_hengkimlay" :blank-page="'_blank'" variant="btn-dark" />
        <button @click="navActive" class="lg:hidden btn-dark px-4 py-2 rounded-full group">
          <img class="group-focus:scale-100 group-hover:scale-110 transition-all"
